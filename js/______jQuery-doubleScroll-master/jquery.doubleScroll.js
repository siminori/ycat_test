...
(function(jQuery){
    jQuery.widget("suwala.doubleScroll", {
		options: {
        ...
        _create : function() {
			...
			var topScrollBar = jQuery(jQuery(self.options.topScrollBarMarkup));
            ...
            jQuery(self.options.topScrollBarInnerSelector, topScrollBar).width(contentElement[0].scrollWidth);
